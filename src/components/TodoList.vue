    ...
    <div class="table-responsive-vertical shadow-z-1">
      <table id="table" class="table table-hover table-mc-blue">
        ...
        <tr v-for="todo in todolist" :key="todo.ids">
          ...
          <td>{{todo.owners}}</td>
          <td>
            <Button depressed small color="warning" v-if="todo.isCompleteds === false" 
              @click="markAsCompleted(todo.ids)" name="markAsCompleted">
               Mark as Done
            </Button>
            <Button depressed small color="success" v-if="todo.isCompleteds === true" 
